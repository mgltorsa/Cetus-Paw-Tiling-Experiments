...
int main(int argc, char const *argv[])
{
	...
	{
		printf("vector-mult,parallel-paw-single-tiled-loop-inter,%d,%s,%d,%d,mem-allocation-error\n", cores, eventLabel, m, n);
		return 1;
	}
	...
	printf("vector-mult,parallel-paw-single-tiled-loop-inter,%d,%s,%d,%d,%d,%lld\n", cores, eventLabel, m, n, balancedTileSize, measurement);
	_ret_val_0 = 0;
	return _ret_val_0;
}
